...
void print_winner(void)
{
    ...
    int highestVotes = findHighestVotes();
    for (int i = 0; i < candidate_count; i++)
    {
...
//                 int temp1 = candidates[i].votes;
//                 candidates[i].votes = candidates[i + 1].votes;
//                 candidates[i + 1].votes = temp1;

//                 string temp2 = candidates[i].name;
//                 candidates[i].name = candidates[i + 1].name;
//                 candidates[i + 1].name = temp2;
