...
char random_allele();
char random_allele_from_parent(char allele0, char allele1);
...
person *create_family(int generations)
{
    ...
    if (generations > 1)
    {
        ...
        child->alleles[0] = random_allele_from_parent(parent0->alleles[0], parent0->alleles[1]);
        child->alleles[1] = random_allele_from_parent(parent1->alleles[0], parent1->alleles[1]);
    }
